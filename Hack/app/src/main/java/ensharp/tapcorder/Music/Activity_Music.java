 ...
 */
public class Activity_Music extends BT_Preference implements TextToSpeech.OnInitListener,View.OnClickListener {
        ...
        if (status == TextToSpeech.SUCCESS) {
            ...
            if (result == TextToSpeech.LANG_MISSING_DATA
                ...
                try
                {
                    ...
                    startActivity(new Intent(Activity_Music.this, MainActivity.class));
